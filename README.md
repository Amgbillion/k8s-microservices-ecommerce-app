...
3. **Clone Repository**: `git clone https://github.com/Amgbillion/k8s-microservices-ecommerce-app.git`
...
```sh
git clone https://github.com/Amgbillion/k8s-microservices-ecommerce-app.git
